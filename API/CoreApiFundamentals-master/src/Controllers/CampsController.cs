...
{
    //el [controller] es para no colocar el nombre especifico del controller en la ruta es para que tome el de la clase automaticamente
    [Route("api/[controller]")]
    [ApiController] //este atributo se agrega para activar el model binding 
